...
// Manual Input of Total Cost
    ...
    public function finalize_update($foodforwork_id,$fundsource_id,$total_cost,$saa_id,$regioncode,$project_title)
    {
        $this->db->trans_begin();
    ...
    {
        $sql = 'SELECT g.saa_number,a.foodforwork_id,a.project_title,a.region_code,b.region_name,c.work_nature,a.no_of_days,number_of_bene as total_bene, cost_of_assistance as total_cost,a.file_location,a.finalize_status
                FROM `tbl_foodforwork` a
                INNER JOIN lib_region b
                on a.region_code = b.region_code
