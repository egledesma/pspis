...
class fundswithdrawal extends CI_Controller
{

    public function index(){

        $fundswithdrawal_model = new fundsallocation_model();
            $this->load->view('header');
            $this->load->view('navbar');
            $this->load->view('sidebar');
            $this->load->view('fundswithdrawal_list',array(
                'fundswithdrawaldetails' => $fundswithdrawal_model->get_funds()/*'form_message'=>$form_message*/));
