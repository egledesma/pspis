...
class worknature extends CI_Controller
{

    public function index($function = 0){

        $worknature_model = new worknature_model();
        if($function == 0){
            $form_message = '';
        } elseif($function == 1){
        ...
        if (!$this->form_validation->run()){
            ...
            $this->load->view('worknature_list',array(
				'worknatureDetails' => $worknature_model->get_worknature(),'form_message'=>$form_message));
