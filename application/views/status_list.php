        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <table class="table table-hover table-bordered dataTable table-striped width-full" id="exampleTableSearch">
                    ...
                    <tbody>
                    <?php foreach($statusDetails as $statusData): ?>  <!--pagination buttons -->
                        <tr>
                            <td><?php echo $statusData->status_id ?></td>
                            <td><?php echo $statusData->status_name; ?></td>
                            <td><?php echo $statusData->date_created; ?></td>
                            <td><?php echo $statusData->date_modified; ?></td>
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-info btn-outline" data-target="#exampleFormModal1" data-toggle="modal"  href="<?php echo base_url('status/edit/' . $statusData->status_id . '') ?>"><i class="icon wb-edit" aria-hidden="true" data-toggle="tooltip"
                                        data-placement="top" data-original-title="Edit"></i> </a>
                                    <a class="confirmation btn btn-danger btn-outline" id="confirm"
                                       href="<?php echo base_url('status/delete/' . $statusData->status_id . '') ?>" data-toggle="tooltip"
