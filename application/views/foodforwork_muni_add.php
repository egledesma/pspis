...
<script type="text/javascript">
    ...
    function get_muni() {
        ...
        if(prov_code > 0) {
            $.ajax({
                url: "<?php echo base_url('foodforwork/populate_muni/'."$foodforworkpass_id".''); ?>",
                async: false,
                type: "POST",
...
<!--            <li><a href="--><?php //echo base_url('foodforwork/viewfood_muni/'.$foodforworkpass_id.'') ?><!--">City/Municipality</a></li>-->
...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <?php
        $attributes = array("class" => "form-horizontal", "id" => "foodmuniformadd", "name" => "foodmuniformadd");
        //input here the next location when click insert

        echo form_open("foodforwork/addfood_muni", $attributes);?>
        <!--<pre>-->
