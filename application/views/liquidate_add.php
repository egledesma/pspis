        ...
        <div class="panel">
            <header class="panel-heading">
                <div class="panel-heading">
                    <h3 class="panel-title">Liquidate Amount (First Tranche)</h3>
                </div>
            </header>
            <div class="panel-body">
                ...
                <?php
                $attributes = array("class" => "form-horizontal", "id" => "addliquidate", "name" => "addliquidate");
                 echo form_open("budget/addLiquidate", $attributes);?>
                ...
                <div class="form-group row">
                    ...
                    <div class="example">
                        <div id="project_status" class="col-sm-4">
                            <label for="first_tranche" class="control-label">Liquidated Amount for 1st Tranche:</label>
                ...
                <div class="example">
                    ...
                    <div id="start_date" class="col-sm-4">
                        <label for="first_tranche_date" class="control-label">Date Submitted:</label>
