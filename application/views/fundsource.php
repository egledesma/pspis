...
<div class="page ">
    ...
    <div class="page-header page-header-bordered">
        ...
        <h1 class="page-title">Source of Fund</h1>
        <ol class="breadcrumb">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <table class="table table-hover table-bordered dataTable table-striped width-full" id="exampleTableSearch">
                    ...
                    <tbody>
                    <?php foreach($sourceDetails as $sourceData): ?>  <!--pagination buttons -->
                        <tr>
                            <td><?php echo $sourceData->fundsource_id ?></td>
                            <td><?php echo $sourceData->fund_source; ?></td>
                            <td><?php echo $sourceData->date_created; ?></td>
