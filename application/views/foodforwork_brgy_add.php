...
<script type="text/javascript">
    ...
    function get_brgy() {
        ...
        if(city_code > 0) {
            $.ajax({
                url: "<?php echo base_url('foodforwork/populate_brgy/'.$proj_prov->foodforwork_id.''); ?>",
                async: false,
                type: "POST",
...
<!--            <li><a href="--><?php //echo base_url('foodforwork/viewfood_brgy/'.$proj_prov->food_muni_id.'') ?><!--">Barangay</a></li>-->
...
<!--        <div class="panel">-->
                ...
                <?php
                $attributes = array("class" => "form-horizontal", "id" => "foodbrgyformadd", "name" => "foodbrgyformadd");
                //input here the next location when click insert

                echo form_open("foodforwork/addfood_brgy", $attributes);?>
                ...
                <input class="form-control" id = "foodforwork_id_pass" name ="foodforwork_id_pass" type = "hidden" value = "<?php echo $proj_prov->foodforwork_id;?>">
                <input class="form-control" id = "food_muni_id_pass" name ="food_muni_id_pass" type = "hidden" value = "<?php echo $proj_prov->food_muni_id;?>">
