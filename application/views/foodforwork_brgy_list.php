            ...
            <td>
                <button type="submit" onclick = "javascript: window.parent.closeIframe();" id="btn_exit" name="btn_exit" class="btn btn-outline btn-danger " data-toggle="tooltip"
                    ...
                    <table class="table table-hover table-bordered dataTable table-striped width-full" id="exampleTableSearch">
                        ...
                        <?php foreach($foodbrgy_list as $foodbrgy_listData): ?>
                            <tr>
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
<!--                                        <a class="btn btn-dark btn-outline" id="confirm"-->
<!--                                           href="--><?php //echo base_url('foodforwork/view/'.$foodbrgy_listData->food_brgy_id.'') ?><!--" data-toggle="tooltip"-->
<!--                                           data-placement="top" data-original-title="View Project"><i class="icon wb-search" aria-hidden="true"></i></a>-->
                                        <a class="btn btn-info btn-outline" id="confirm"
                                           href="<?php echo base_url('foodforwork/updatefoodforwork_brgy/'.$foodbrgy_listData->food_brgy_id.'/2') ?>" data-toggle="tooltip"
                                        ...
                                        <a class="confirmation btn btn-danger btn-outline" id="confirm"
                                           href="<?php echo base_url('foodforwork/deletefoodforwork_brgy/'.$foodbrgy_listData->food_brgy_id.'/3') ?>" data-toggle="tooltip"
                                        ...
                                        <a class="confirmation btn btn-success btn-outline" id="confirm"
                                           href="<?php echo base_url('foodforwork/food_benelist/'.$foodbrgy_listData->food_brgy_id.'/0') ?>" data-toggle="tooltip"
                                           data-placement="top" data-original-title="Add Beneficiaries"><i class="icon wb-user-add" aria-hidden="true"></i> </a>
                                    </div>

                                </td>
                                <td><?php echo $foodbrgy_listData->brgy_name; ?></td>
                                <td><?php echo  $foodbrgy_listData->no_of_bene_brgy; ?></td>
                                <td><?php echo '₱ '. number_format($foodbrgy_listData->cost_of_assistance_brgy,2); ?></td>
