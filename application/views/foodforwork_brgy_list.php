...
<!--                                           data-placement="top" data-original-title="View Project"><i class="icon wb-search" aria-hidden="true"></i></a>-->
                                        <a class="btn btn-info btn-outline" id="confirm"
                                           href="<?php echo base_url('foodforwork/updatefoodforwork_brgy/'.$foodbrgy_listData->food_brgy_id.'') ?>" data-toggle="tooltip"
                                        ...
                                        <a class="confirmation btn btn-danger btn-outline" id="confirm"
                                           href="<?php echo base_url('foodforwork/deletefoodforwork_brgy/'.$foodbrgy_listData->food_brgy_id.'') ?>" data-toggle="tooltip"
                                        ...
                                        <a class="confirmation btn btn-success btn-outline" id="confirm"
                                           href="<?php echo base_url('foodforwork/food_benelist/'.$foodbrgy_listData->food_brgy_id.'') ?>" data-toggle="tooltip"
