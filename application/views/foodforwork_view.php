                    ...
                    <div class="panel-body">
                        <div>
                            <ul class="list-group list-group-dividered list-group-full col-lg-3">
                                ...
                                <li class="list-group-item"> City/Municipality:  <b><?php echo $project->city_name ?></b></li>
                            </ul>
                        </div>
                        <div>
                            <ul class="list-group list-group-dividered list-group-full col-lg-3">
                                ...
                                <li class="list-group-item"> Number of Beneficiaries: <b><?php echo $project->no_of_bene ?></b></li>
                        ...
                        <div>
                            <ul class="list-group list-group-dividered list-group-full col-lg-3">
                                ...
                                <li class="list-group-item"> Cost of Assistance: <b><?php echo '₱ '. number_format($project->cost_of_assistance,2);  ?></b></li>
                            </ul>
                        </div>
                    </div>
