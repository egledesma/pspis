<div class="page ">
    ...
    <div class="page-header page-header-bordered">
        ...
        <h1 class="page-title">SAA Allocation History</h1>
        <ol class="breadcrumb">
    ...
    <div class="panel">
        <div class="panel">
            <header class="panel-heading">
                <h1 class="panel-title"><mark class="bg-dark">&nbsp;&nbsp;&nbsp; <?php echo $saaallocated->saa_number ?> - Funds History&nbsp;&nbsp;&nbsp;</mark>&nbsp;&nbsp;&nbsp;<mark class="bg-info">&nbsp;&nbsp;&nbsp; <?php echo $region->region_name ?>&nbsp;&nbsp;&nbsp;</mark></h1>
            </header>
