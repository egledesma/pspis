    ...
    <div class="page-content">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <?php
                $attributes = array("class" => "form-horizontal", "id" => "familyinfoform", "name" => "familyinfoform");
                    ...
                    <tr>
                        <td>
                            <select name="lgucounterpartlist" id="lgucounterpartlist" class="form-control">
                                ...
                                <?php foreach($lgucounterpartlist as $lgucounterpartlist): ?>
                                    <option value="<?php echo $lgucounterpartlist->lgucounterpart_id; ?>">
                                        <?php echo $lgucounterpartlist->lgu_counterpart; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </td>
