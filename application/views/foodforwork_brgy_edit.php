...
<script type="text/javascript">
    ...
    function get_brgy() {
        ...
        if(city_code > 0) {
            $.ajax({
                url: "<?php echo base_url('foodforwork/populate_brgy_edit/'.$proj_brgy->foodforwork_id.'/'.$proj_brgy->brgy_code.''); ?>",
                async: false,
                type: "POST",
...
<!--</pre>-->
                <?php
                $attributes = array("class" => "form-horizontal", "id" => "foodbrgyformedit", "name" => "foodbrgyformedit");
                //input here the next location when click insert

                echo form_open("foodforwork/updatefoodforwork_brgy", $attributes);?>
...
<!--                <input class="form-control" id = "foodforwork" name ="foodforwork" type = "text" value = "--><?php //echo $proj_brgy->foodforwork_id;?><!--">-->
<!--                <input class="form-control" id = "foodforwork_id_pass" name ="foodforwork_id_pass" type = "text" value = "--><?php //echo $proj_brgy->foodforwork_id;?><!--">-->
                <input class="form-control" id = "food_muni_id_pass" name ="food_muni_id_pass" type = "hidden" value = "<?php echo $proj_brgy->foodforwork_muni_id;?>">
                <input class="form-control" id = "food_brgy_id_pass" name ="food_brgy_id_pass" type = "hidden" value = "<?php echo $proj_brgy->food_brgy_id;?>">
