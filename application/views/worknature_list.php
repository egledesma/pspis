...
<div class="page ">
    ...
    <div class="page-header page-header-bordered">
        ...
        <h1 class="page-title">Nature of Work</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('dashboardc/dashboard') ?>">Dashboard</a></li>
            <li><a href="<?php echo base_url('libraries/index') ?>">Libraries</a></li>
            <li class="active">Nature of Work</li>
        </ol>
    </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <table class="table table-hover table-bordered dataTable table-striped width-full" id="exampleTableSearch">
                    ...
                    <tbody>
                    <?php foreach($worknatureDetails as $worknatureData): ?>  <!--pagination buttons -->
                        <tr>
                            <td><?php echo $worknatureData->natureid ?></td>
                            <td><?php echo $worknatureData->work_nature; ?></td>
                            <td><?php echo $worknatureData->date_created; ?></td>
                            <td><?php echo $worknatureData->date_modified; ?></td>
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-info btn-outline" data-target="#exampleFormModal1" data-toggle="modal"  href="<?php echo base_url('lgu/edit/' . $worknatureData->natureid . '') ?>"><i class="icon wb-edit" aria-hidden="true" data-toggle="tooltip"
                                        data-placement="top" data-original-title="Edit"></i> </a>
                                    <a class="confirmation btn btn-danger btn-outline" id="confirm"
                                       href="<?php echo base_url('lgu/delete/' . $worknatureData->natureid . '') ?>" data-toggle="tooltip"
