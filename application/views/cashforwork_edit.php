...
<script type="text/javascript">
    ...
    function get_natureofwork() {
        ...
        var natureofwork_id = <?php echo $cashforworkdata->nature_id; ?>

        if(assistance_id > 0) {
            $.ajax({
                url: "<?php echo base_url('cashforwork/populate_natureofwork'); ?>",
                async: false,
                type: "POST",
        ...
        <div class="panel">
            <header class="panel-heading">
                <div class="panel-heading">
                    <h3 class="panel-title">Edit Project(Cash for work)</h3>
                </div>
            </header>
            <div class="panel-body">
                ...
                echo form_open("cashforwork/updateCashforwork", $attributes);?>
                <!--<pre>-->
                ...
                <input type="hidden" id = "cashforwork_id" name = "cashforwork_id" value = "<?php echo $cashforworkdata->cashforwork_id ?>">
                <div class="form-group row">
                    <div id="project_title" class="col-sm-6">
                        <label for="project_title" class="control-label">Project Title:</label>
                        <input id="project_title" name="project_title" placeholder="Project Title" type="text"  class="form-control"  value="<?php echo $cashforworkdata->project_title ?>" required/>
                        ...
                        <select  name="regionlist" id="regionlist" class="form-control" onChange="get_prov();">
                            ...
                            <?php foreach($regionlist as $regionselect): ?>
                                <option value="<?php echo $regionselect->region_code; ?>"
                                    <?php if(isset($cashforworkdata->region_code )) {
                                        if($regionselect->region_code == $cashforworkdata->region_code) {
                                            echo " selected";
                                        }
                                    } ?>
                                >
                ...
                <div class="form-group row">
                            ...
                            <select required id="natureofworklist" name="natureofworklist" class="form-control" required="required">
                                ...
                                foreach ($natureofworklist as $natureofworkselect) { ?>
                                    <option value="<?php echo $natureofworkselect->nature_id; ?>"
                                        <?php
                                        if ($natureofworkselect->nature_id == $cashforworkdata->nature_id) {
                                            echo " selected";
                                        } ?>
                                    >
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            ...
                            <input id="number_bene" name="number_bene" placeholder="Number of Beneficiaries" type="number" min="0"  class="form-control"  value="<?php echo $cashforworkdata->no_of_bene ?>" required autofocus/>
                        ...
                        <div class="col-sm-4">
                            ...
                            <input id="cost_of_assistance" name="cost_of_assistance" placeholder="Cost of Assistance" type="text"  class="form-control"  value="<?php echo $cashforworkdata->cost_of_assistance ?>" required autofocus/>
